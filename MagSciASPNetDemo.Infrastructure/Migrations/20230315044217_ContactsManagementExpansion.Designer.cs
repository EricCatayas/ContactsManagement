...
namespace ContactsManagement.Infrastructure.Migrations
{
    ...
    [Migration("20230315044217_ContactsManagementExpansion")]
    partial class ContactsManagementExpansion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactGroupPerson", b =>
                {
                    ...
                    b.HasKey("ContactGroupsId", "PersonsId");
            ...
            modelBuilder.Entity("ContactsManagement.Core.Domain.Entities.ContactsManager.Company", b =>
                {
                    ...
                    b.Property<string>("CompanyProfileBlobUrl")
            ...
            modelBuilder.Entity("ContactsManagement.Core.Domain.Entities.ContactsManager.FileAttachment", b =>
                {
            ...
            modelBuilder.Entity("ContactsManagement.Core.Domain.Entities.StockTrade.BuyOrder", b =>
                {
            ...
            modelBuilder.Entity("ContactsManagement.Core.Domain.Entities.StockTrade.SellOrder", b =>
                {
            ...
            modelBuilder.Entity("ContactsManagement.Core.Domain.Entities.ContactsManager.FileAttachment", b =>
                {
                    b.HasOne("ContactsManagement.Core.Domain.Entities.ContactsManager.ContactLog", null)
                        .WithMany("Attachments")
                        .HasForeignKey("ContactLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
