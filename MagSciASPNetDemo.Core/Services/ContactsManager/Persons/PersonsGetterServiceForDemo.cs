...
{
    public class PersonsGetterServiceForDemo : IPersonsGetterService
    {
        ...
        public PersonsGetterServiceForDemo(IPersonsGetterRepository personsRepository, IDiagnosticContext diagnostics, ISignedInUserService signedInUserService, IDemoUserService demoUserService)
        {
