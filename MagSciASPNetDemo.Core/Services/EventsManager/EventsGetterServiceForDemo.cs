...
{
    public class EventsGetterServiceForDemo : IEventsGetterService
    {
        ...
        public EventsGetterServiceForDemo(IEventsGetterRepository eventsGetterRepository, IEventsStatusUpdaterRepository eventsStatusUpdaterRepository, ISignedInUserService signedInUserService, IDemoUserService demoUserService)
        {
